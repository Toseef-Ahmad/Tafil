...
- **Windows** 10/11 — [Download .exe](https://github.com/Toseef-Ahmad/Tafil/releases/download/v1.0.0/Tafil-1.0.0-darwin.exe)
- **Linux** (x64 / ARM64) — [Download .AppImage](https://github.com/Toseef-Ahmad/Tafil/releases)
